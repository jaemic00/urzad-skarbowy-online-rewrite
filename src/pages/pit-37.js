...
const PIT37Page = () => {
  ...
  return (
  <>
      <Helmet title="e-Urząd Skarbowy Online &raquo; Rozliczenie PIT-37 2021 za rok 2020 z oficjalnym Urzędowym Poświadczeniem Odbioru" description="Urząd Skarbowy Online" />
      <Container style={{padding: '0'}} fluid>
      <Menubar />
      <MainBanner header={ typeof(headerValue) != "undefined" ? headerValue : "PIT-37 z PITax.pl" } buttonValue={buttonValue}/>
      <PartnersBar />
