...
const buttonValue = "Rozpocznij Rozliczenie PIT Online";
...
const PITOnlinePage = () => {
  ...
  <>
      ...
      <Menubar />
      <MainBanner header={ typeof(headerValue) != "undefined" ? headerValue : "PIT-Online" } buttonValue={buttonValue}/>
      <PartnersBar />
