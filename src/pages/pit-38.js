...
const PIT38Page = () => {
  ...
  return (
  <>
      <Helmet title="e-Urząd Skarbowy Online &raquo; Rozliczenie PIT 38 2021 za rok 2020 z oficjalnym Urzędowym Poświadczeniem Odbioru" description="Urząd Skarbowy Online" />
      <Container style={{padding: '0'}} fluid>
      <Menubar />
      <MainBanner header={ typeof(headerValue) != "undefined" ? headerValue : "PIT-38 z PITax.pl" } buttonValue={buttonValue}/>
      <PartnersBar />
